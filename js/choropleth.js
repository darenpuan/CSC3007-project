        ...
        for (let i = 0; i < countryList.length; i++) {
          if (d.properties.name == countryList[i]) {
            if (
              ...
              dataJson[countryList[i]][selected_dataset] > 600 &&
              dataJson[countryList[i]][selected_dataset] <= 100000
            ) {
              return "#EB6C61";
            } else if (
              dataJson[countryList[i]][selected_dataset] > 800 &&
              dataJson[countryList[i]][selected_dataset] <= 140000
            ) {
              return "#E4594B";
            } else if (
              dataJson[countryList[i]][selected_dataset] > 1000 &&
              ...
              dataJson[countryList[i]][selected_dataset] > 4000 &&
              dataJson[countryList[i]][selected_dataset] <= 240000
            ) {
              return "#D32C1E";
            } else {
              return "#D7DCFC";
  ...
  let legends = [
    ...
    { label: 140000, color: "#dc4435" },
    { label: 200000, color: "#d32c1e" },
    { label: 240000, color: "#9c2900" },
  ];
  ...
  Promise.all([
    ...
    console.log(dataJson["Antarctica"]);
    ...
    function displayData(d, selected_dataset) {
      try {
        if (dataJson[d.properties.name][selected_dataset] == undefined) {
